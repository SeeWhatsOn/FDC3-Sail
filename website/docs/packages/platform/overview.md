...
in any form; see [`.cursor/plans/sail-platform-extensibility.md`](https://github.com/finos/FDC3-Sail/blob/main/.cursor/plans/sail-platform-extensibility.md)
for the direction and the trigger that would start that work.
