...
export type ElectronHelloArgs = DesktopAgentConnectionArgs & {
  url: string
}
...
export type DesktopAgentConnectionArgs = {
  userSessionId: string
  directories: string[]
  channels: TabDetail[]
  panels: AppPanel[]
...
export type SailClientStateArgs = DesktopAgentConnectionArgs
