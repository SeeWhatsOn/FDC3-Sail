...
export class DesktopAgent {
  ...
  private browserAppConnection?: BrowserAppConnection
  ...
  start(): void {
    ...
    this.browserAppConnection?.start()

    if (this.browserAppConnection) {
      this.browserAppConnection.onAppMessage(message => {
  ...
  stop(): void {
    ...
    this.browserAppConnection?.stop()
    if (!this.browserAppConnection) {
  ...
  getAppConnection(instanceId: string): AppConnectionMetadata | undefined {
    return this.browserAppConnection?.getConnection(instanceId)
  }
  ...
  getAppConnections(): AppConnectionMetadata[] {
    return this.browserAppConnection?.getConnections() ?? []
  }
  ...
  disconnectInstance(instanceId: string): void {
    ...
    this.browserAppConnection?.pruneAppConnection(instanceId)
  }
