...
/**
 * Find the best App Directory match for a WCP4 identityUrl (FDC3 2.2).
 * Scores by origin + optional path/hash/query constraints from the directory URL.
 */
...
function getAppDirectoryUrl(app: DirectoryApp): string | undefined {
  return "url" in app.details && typeof app.details.url === "string"
    ? app.details.url
    : undefined
}
