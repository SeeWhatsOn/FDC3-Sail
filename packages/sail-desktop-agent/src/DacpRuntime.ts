 ...
 */
export interface DacpRuntime {
  /**
   * Returns the directory used by this DacpRuntime.
   */
  ...
  /**
   * Return the list of all apps that have ever been registered with this runtime.
   */
