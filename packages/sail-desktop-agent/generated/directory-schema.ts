...
export interface components {
  schemas: {
    ...
    LaunchDetails:
      | components["schemas"]["WebAppDetails"]
      | components["schemas"]["NativeAppDetails"]
      | components["schemas"]["CitrixAppDetails"]
      | components["schemas"]["OnlineNativeAppDetails"]
      | components["schemas"]["OtherAppDetails"]
    ...
    OtherAppDetails: Record<string, never>
