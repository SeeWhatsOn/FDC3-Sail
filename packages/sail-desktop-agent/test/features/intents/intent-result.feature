Feature: Intent Results Are Correctly Delivered
  ...
  Scenario: App Returns An Intent Response
    ...
    Then messaging will have outgoing posts
      ...
      | intentEvent               | {lastIntentEventUuid} | {null}               | PortfolioApp | l1            | ABC123                             | {null}                                         | {null}                                | App1                              | a1                                     | ISO8601-timestamp-required     | {null}                         |
      | raiseIntentResponse       | {null}             | ABC123               | App1         | a1            | {null}                             | l1                                             | {null}                                | {null}                            | {null}                                 | {null}                         | {null}                         |
  ...
  Scenario: App Returns An Intent Result
    ...
    Then messaging will have outgoing posts
      ...
      | intentEvent               | {lastIntentEventUuid} | PortfolioApp | l1            | ABC123                             | {null}                                         | {null}                              | App1                              | a1                                     | ISO8601-timestamp-required     | {null}                         |
      | raiseIntentResponse       | {null}             | App1         | a1            | {null}                             | l1                                             | {null}                              | {null}                            | {null}                                 | {null}                         | {null}                         |
