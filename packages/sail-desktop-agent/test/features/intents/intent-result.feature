Feature: Intent Results Are Correctly Delivered
  ...
  Scenario: Waiting for an intent listener to be Added
    ...
    Then messaging will have outgoing posts
      | msg.matches_type          | msg.meta.eventUuid | to.appId     | to.instanceId | msg.payload.raiseIntentRequestUuid | msg.payload.intentResolution.source.instanceId | msg.payload.intentResult.context.type | msg.payload.metadata.source.appId | msg.payload.metadata.source.instanceId | msg.payload.metadata.timestamp |
      | intentEvent               | {lastIntentEventUuid} | App1         | a1            | ABC123                             | {null}                                         | {null}                                | PortfolioApp                      | l1                                     | ISO8601-timestamp-required     |
      | raiseIntentResponse       | {null}             | PortfolioApp | l1            | {null}                             | a1                                             | {null}                                | {null}                            | {null}                                 | {null}                         |
      | raiseIntentResultResponse | {null}             | PortfolioApp | l1            | {null}                             | {null}                                         | {null}                                | App1                              | a1                                     | ISO8601-timestamp-required     |
      | intentResultResponse      | {null}             | App1         | a1            | {null}                             | {null}                                         | {null}                                | {null}                            | {null}                                 | {null}                         |
  ...
  Scenario: App Returns An Intent Response
    ...
    Then messaging will have outgoing posts
      ...
      | intentEvent               | {lastIntentEventUuid} | {null}               | PortfolioApp | l1            | ABC123                             | {null}                                         | {null}                                | App1                              | a1                                     | ISO8601-timestamp-required     |
      | raiseIntentResponse       | {null}             | ABC123               | App1         | a1            | {null}                             | l1                                             | {null}                                | {null}                            | {null}                                 | {null}                         |
      | raiseIntentResultResponse | {null}             | ABC123               | App1         | a1            | {null}                             | {null}                                         | fdc3.portfolio                        | PortfolioApp                      | l1                                     | ISO8601-timestamp-required     |
      | intentResultResponse      | {null}             | {lastIntentResultRequestUuid} | PortfolioApp | l1            | {null}                             | {null}                                         | {null}                                | {null}                            | {null}                                 | {null}                         |
  ...
  Scenario: App Returns An Intent Result
    ...
    Then messaging will have outgoing posts
      | msg.matches_type          | msg.meta.eventUuid | to.appId     | to.instanceId | msg.payload.raiseIntentRequestUuid | msg.payload.intentResolution.source.instanceId | msg.payload.intentResult.channel.id | msg.payload.metadata.source.appId | msg.payload.metadata.source.instanceId | msg.payload.metadata.timestamp |
      | intentEvent               | {lastIntentEventUuid} | PortfolioApp | l1            | ABC123                             | {null}                                         | {null}                              | App1                              | a1                                     | ISO8601-timestamp-required     |
      | raiseIntentResponse       | {null}             | App1         | a1            | {null}                             | l1                                             | {null}                              | {null}                            | {null}                                 | {null}                         |
      | raiseIntentResultResponse | {null}             | App1         | a1            | {null}                             | {null}                                         | pc1                                 | PortfolioApp                      | l1                                     | ISO8601-timestamp-required     |
      | intentResultResponse      | {null}             | PortfolioApp | l1            | {null}                             | {null}                                         | {null}                              | {null}                            | {null}                                 | {null}                         |
  ...
  Scenario: App Returns A Void Intent Result
    ...
    Then messaging will have outgoing posts
      ...
      | intentEvent               | {lastIntentEventUuid} | PortfolioApp | l1            | ABC123                             | {null}                                         | {null}                                | App1                              | a1                                     | ISO8601-timestamp-required     |
      | raiseIntentResponse       | {null}             | App1         | a1            | {null}                             | l1                                             | {null}                                | {null}                            | {null}                                 | {null}                         |
      | raiseIntentResultResponse | {null}             | App1         | a1            | {null}                             | {null}                                         | {null}                                | PortfolioApp                      | l1                                     | ISO8601-timestamp-required     |
      | intentResultResponse      | {null}             | PortfolioApp | l1            | {null}                             | {null}                                         | {null}                                | {null}                            | {null}                                 | {null}                         |
