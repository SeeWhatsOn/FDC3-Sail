...
function generateBaseMessageSchema() {
...
function generateZodFromJsonSchema(schemaName, schema, originalName) {
...
function generateRequestSchema(schemaName, originalName) {
...
function generateResponseSchema(schemaName, originalName) {
...
function generateEventSchema(schemaName, originalName) {
    return `// ${schemaName}
export const ${schemaName}Schema = z.object({
  type: z.literal('${originalName}'),
  payload: z.unknown().optional(),
...
function getPayloadSchemaForRequest(requestType) {
    switch (requestType) {
...
function getPayloadSchemaForResponse(responseType) {
    switch (responseType) {
...
function generateMessageTypeUnion(schemas) {
