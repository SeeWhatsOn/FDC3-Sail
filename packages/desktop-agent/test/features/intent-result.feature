Feature: Intent Results Are Correctly Delivered
  ...
  Scenario: Waiting for an intent listener to be Added
    When "appId: PortfolioApp, instanceId: l1" raises an intent for "viewNews" with contextType "fdc3.instrument" on app "appId: App1, instanceId: a1" with requestUuid "ABC123"
    And "appId: App1, instanceId: a1" registers an intent listener for "viewNews"
    And "appId: App1, instanceId: a1" sends a intentResultRequest with eventUuid "uuid10" and void contents and raiseIntentUuid "ABC123"
  ...
  Scenario: App Returns An Intent Response
    When "appId: App1, instanceId: a1" raises an intent for "ViewPortfolio" with contextType "fdc3.portfolio" on app "appId: PortfolioApp, instanceId: l1" with requestUuid "ABC123"
    When "appId: PortfolioApp, instanceId: l1" sends a intentResultRequest with eventUuid "uuid7" and contextType "fdc3.portfolio" and raiseIntentUuid "ABC123"
    Then messaging will have outgoing posts
  ...
  Scenario: App Returns An Intent Result
    When "appId: App1, instanceId: a1" raises an intent for "ViewPortfolio" with contextType "fdc3.portfolio" on app "appId: PortfolioApp, instanceId: l1" with requestUuid "ABC123"
    When "appId: PortfolioApp, instanceId: l1" sends a intentResultRequest with eventUuid "uuid7" and private channel "pc1" and raiseIntentUuid "ABC123"
    Then messaging will have outgoing posts
  ...
  Scenario: App Returns A Void Intent Result
    When "appId: App1, instanceId: a1" raises an intent for "ViewPortfolio" with contextType "fdc3.portfolio" on app "appId: PortfolioApp, instanceId: l1" with requestUuid "ABC123"
    When "appId: PortfolioApp, instanceId: l1" sends a intentResultRequest with eventUuid "uuid7" and void contents and raiseIntentUuid "ABC123"
    Then messaging will have outgoing posts
      | msg.matches_type          | msg.meta.eventUuid | to.appId     | to.instanceId | msg.payload.raiseIntentRequestUuid | msg.payload.intentResolution.source.instanceId | msg.payload.intentResult.context.type |
      | intentEvent               | uuid7              | PortfolioApp | l1            | ABC123                             | {null}                                         | {null}                                |
      | raiseIntentResponse       | {null}             | App1         | a1            | {null}                             | l1                                             | {null}                                |
