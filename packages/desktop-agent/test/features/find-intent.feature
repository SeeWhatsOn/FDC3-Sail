Feature: Find Intent API
  ...
  Background:
    ...
    And "App1/b1" registers an intent listener for "ViewPortfolio"
  ...
  Scenario: Unsuccessful Find Intents Request
    When "App1/a1" finds intents with intent "ViewChart" and contextType "fdc3.instrument" and result type "{empty}"
  ...
  Scenario: Unsuccessful Find Intents Request With Result Type
    When "App1/a1" finds intents with intent "ViewChart" and contextType "{empty}" and result type "unknownContext"
    Then messaging will have outgoing posts
      | msg.matches_type   | msg.payload.appIntent.intent.name | msg.payload.appIntent.apps.length | to.instanceId |
      | findIntentResponse | ViewChart                         |                                 0 | a1            |

  Scenario: Successful Find Intents Request
    When "App1/a1" finds intents with intent "ViewChart" and contextType "{empty}" and result type "{empty}"
    Then messaging will have outgoing posts
  ...
  Scenario: Find Intents by Context Request
    When "App/a1" finds intents with contextType "fdc3.portfolio"
    Then messaging will have outgoing posts
  ...
  Scenario: Successful Find Intents Request With Channel
    When "App1/a1" finds intents with intent "StreamChart" and contextType "fdc3.portfolio" and result type "channel"
    Then messaging will have outgoing posts
  ...
  Scenario: Successful Find Intents Request With A Typed Channel
    When "App1/a1" finds intents with intent "StreamChart" and contextType "{empty}" and result type "channel<chart>"
    Then messaging will have outgoing posts
      | msg.matches_type   | msg.payload.appIntent.intent.name | msg.payload.appIntent.apps.length | msg.payload.appIntent.apps[0].appId | to.instanceId |
      | findIntentResponse | StreamChart                       |                                 1 | portfolioApp                         | a1            |

  Scenario: Unsuccessful Find Intents Request With an untyped Channel
    When "App1/a1" finds intents with intent "StreamInstrument" and contextType "{empty}" and result type "channel<spurious>"
    Then messaging will have outgoing posts
  ...
  Scenario: Find Intent includes results for a running app with intent listener
    When "App1/a1" finds intents with intent "ViewPortfolio" and contextType "fdc3.portfolio" and result type "{empty}"
    Then messaging will have outgoing posts
      | msg.matches_type   | msg.payload.appIntent.intent.name | msg.payload.appIntent.apps.length | to.instanceId |
  ...
  Scenario: Disconnecting The Intent Listener
    ...
    And "App1/a1" finds intents with intent "ViewPortfolio" and contextType "fdc3.portfolio" and result type "{empty}"
    Then messaging will have outgoing posts
